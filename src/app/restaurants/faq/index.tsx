...
export default function FAQ({ className }: { className?: string }) {
    ...
    return (
        <div className={`${styles.container} ${className}`}>
            ...
            <ExpandableText onClick={() => setActiveIndex(3)} active={activeIndex === 3} title="How will my restaurant be promoted?" body="Your restaurant will appear on the meal list, the occasional social media post, as well as the recent donations slider on the homepage." />
            <ExpandableText onClick={() => setActiveIndex(4)} active={activeIndex === 4} title="Can customers donate any meal?" body="That is the idea! However, in the end you decide which items can be donated." />
